...
public class ChickenOfTheWoodsCropBlock extends MushroomCropBlock {
    public ChickenOfTheWoodsCropBlock(Properties pProperties) {
        super(pProperties);
    }

    protected ItemLike getBaseSeedId() {
        return MCPlusItems.CHICKEN_OF_THE_WOODS_SPORES.get();
    }
